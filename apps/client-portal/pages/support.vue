...
const ticketTypeOptions = [
  ...
  { value: 'tariff', label: 'Смена услуги' },
...
const faqCategories = [
  {
    ...
    items: [
      ...
      { question: 'Почему списали больше обычного?', answer: 'Возможно, вы подключили дополнительные услуги или изменилась стоимость. Проверьте историю операций для детальной информации.' },
    ],
  },
  {
    id: 'internet',
  ...
  },
  {
    ...
    items: [
      { question: 'Как сменить услугу?', answer: 'Перейдите в раздел "Услуги", выберите нужную услугу и нажмите "Подключить". Изменения применятся с начала следующего периода или сразу с перерасчётом.' },
